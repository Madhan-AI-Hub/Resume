        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
              Candidate: <span className="font-semibold text-slate-700 dark:text-slate-200">{data.user || "Candidate"}</span> <br className="sm:hidden" /> <span className="hidden sm:inline">•</span> Target: <span className="font-semibold text-slate-700 dark:text-slate-200">{data.role || "Target Role"}</span>
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            ...
            <button 
              onClick={handlePrint}
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2 text-sm font-bold text-white bg-blue-600 rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-500/20 transition-all active:scale-95"
            >
